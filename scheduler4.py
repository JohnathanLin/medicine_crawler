...
def crawler(url):
    ...
    headers['Cookie'] = 'PHPSESSID=d276d01fb5df58cf1f25da18db1b1867; expires=Sat, 15-Aug-2020 02:30:33 GMT; Max-Age=86400; path=/; domain=.huatuoyf.com; HttpOnly'
    ...
    target_list = html_content.select('.dollor')
    for target in target_list:
        res_url = 'http://www.huatuoyf.com' + target['href']
...
def get_document(page_num, thread_number, collection_name):
    ...
    """
    # 获取省份和城市信息
    parent_url = 'http://www.huatuoyf.com/category/1.htm?order=0&page='
    # 将所有Url装进队列，用于多线程爬取
...
def geturl():
    ...
    url_mongo_collection = "4_url"
    mongo_url_detail_collection = '4_url_detail'
